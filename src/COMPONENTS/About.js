        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 md:mb-16">
          <div className="flex justify-center order-1 md:order-1">
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-1000 animate-pulse"></div>
          ...
          <div className="space-y-6 order-2 md:order-2">
            <div className="bg-gradient-to-br from-[#1a2845]/80 to-[#0f1f3a]/80 border border-blue-500/20 rounded-2xl p-6 md:p-8 backdrop-blur-xl shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:-translate-y-1">
            ...
            <div className="bg-gradient-to-br from-[#1a2845]/80 to-[#0f1f3a]/80 border border-blue-500/20 rounded-2xl p-6 md:p-8 backdrop-blur-xl shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:-translate-y-1">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-gray-300 text-sm md:text-base">
                  <span className="text-cyan-400 text-xl flex-shrink-0 mt-0.5">
                    ✓
                  </span>
