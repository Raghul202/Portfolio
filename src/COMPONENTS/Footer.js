  ...
  return (
    <footer className="bg-gradient-to-b from-[#0a1628] to-[#050d1a] text-white border-t border-blue-500/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/50">
        ...
        {/* Bottom: Copyright */}
        <div className="pt-6 md:pt-8 border-t border-blue-500/20">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 md:gap-4">
            <p className="text-gray-400 text-xs md:text-sm text-center sm:text-left">
              © {currentYear}{" "}
              <span className="text-cyan-400 font-semibold">Raghul M</span>. All
              rights reserved.
            </p>
